...
export default function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
    ...
    return senhaArray.join('').slice(0, qtd).match(/.{1,10}/g).join('<br>'); 
    //o .join('') junta todos os elementos do senhaArray em uma string 
    //match(/.{1,10}/g) para dividir a senha em grupos de 10 caracteres
}
